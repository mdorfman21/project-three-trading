      ...
      <div>
        <Container>
          ...
          <Row>
            <Col>
              <p className="font">
                Here we have a graph showing just one securities' bollinger
                bands. This is to just get some more information about the
                security of your choosing.
              </p>
              <p className="font">
          ...
          <Row>
            <Col>
              <p className="font">
                Below we have key financial statistics about the security you
                are searching for. These can be used for indicators for certain
                trading strategies.
              </p>
            </Col>
          </Row>
